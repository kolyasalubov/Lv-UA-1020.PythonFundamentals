pythons_philosophy = '''The Zen of Python, by Tim Peters
...
number_of_occurrences1 = "better"
count = pythons_philosophy.count(number_of_occurrences1)
print("The number of 'better' is:", count)

number_of_occurrences2 = "never"
count = pythons_philosophy.count(number_of_occurrences2)
print("The number of 'never' is: ", count)

number_of_occurrences3 = "is"
count = pythons_philosophy.count(number_of_occurrences3)
print("The number of 'is':", count)


print(pythons_philosophy.upper())


new_text = pythons_philosophy.replace('i', '&')
print(new_text)